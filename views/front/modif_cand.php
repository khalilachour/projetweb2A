                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input  type="hidden" name="id" value="<?php echo $candidature['id']; ?>" class="form-control" id="name">
                                            
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="id_offre" value="<?php echo $candidature['id_offre']; ?>" class="form-control" id="email" placeholder="Your Email">
