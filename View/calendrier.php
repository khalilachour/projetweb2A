...
<body>
    ...
    <table class="calendar">
        ...
        <tbody>
            ...
            $file_path = 'c:/xampp/htdocs/projet/View/rendezvous_data.txt';
            ...
            for ($day = $first_day; $day <= $last_day; $day = strtotime('+1 day', $day)) {
                ...
                if (isset($marked_dates[date('Y-m-d', $day)])) {
                    $event = $marked_dates[date('Y-m-d', $day)];
                    echo ' class="marked-date" data-nom-poste="' . $event['nom_poste'] . '" data-lieu="' . $event['lieu'] . '"';
                }
                echo '>' . date('d', $day) . '</td>';
