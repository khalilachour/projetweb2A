...
if(isset($_POST['id'], $_POST['id_offre'], $_POST['id_offre'], $_POST['date'], $_FILES['new_cv'], $_FILES['new_lettre'])){
    $id = $_POST['id'];
    ...
    if($_FILES['new_cv']['name'] != '') {
        ...
        $cv_path = "C:/xampp/htdocs/projet/uploads/" . basename($new_cv);
    ...
    if($_FILES['new_lettre']['name'] != '') {
        ...
        $lettre_path = "../projet/uploads/" . basename($new_lettre);
        // Déplacement du fichier téléchargé vers le dossier uploads
    ...
    $CC->updateCandidature($id, $id_offre, $id_user, $date, $new_cv, $new_lettre);
