<?php
// Inclure les contrôleurs et les modèles nécessaires
...
// Obtenir le mot-clé de recherche s'il est présent
$motCle = isset($_GET['recherche']) ? trim($_GET['recherche']) : '';

// Obtenir le critère de tri s'il est présent
$trier = isset($_GET['trier']) ? trim($_GET['trier']) : '';

// Récupérer les offres avec recherche et tri
$offres = $offresC->affichere($motCle, $trier);
...
<body>
    <div class="container my-5">
        ...
        <form action="../View/calendrier.php" class="me-3">
            <button type="submit"  class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" style="color: blue; text-decoration: none;"><i class="fas fa-sign-out-alt"></i> Rendez-vous</button>
        </form>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <a href="add_cand.php?offre_id=<?= $offre['id'] ?>" class="btn btn-primary">Postuler</a>
