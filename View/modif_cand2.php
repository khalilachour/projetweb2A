...
// Vérifie si l'ID de la candidature est défini dans l'URL
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    // Récupère les détails de la candidature à partir de l'ID
    $candidature = $CC->getCandidatureById($id);
...
<form action="update_cand.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $candidature['id']; ?>">
    
    <input type="text" name="id_offre" value="<?php echo $candidature['id_offre']; ?>">
    
    <input type="text" name="date" value="<?php echo $candidature['date']; ?>">
-->
     <!-- Afficher le nom du fichier CV sans possibilité de modification -->
    <!-- <input type="text" name="cv" value="<?php echo $candidature['cv']; ?>" readonly>
     Champ pour choisir un nouveau fichier CV 
    <input type="file" name="new_cv">

      Afficher le nom du fichier Lettre de motivation sans possibilité de modification -->
     <!--<input type="text" name="lettre" value="<?php echo $candidature['lettre']; ?>" readonly>
     Champ pour choisir un nouveau fichier Lettre de motivation -->
<!--<input type="file" name="new_lettre">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <form action="update_cand2.php" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input  type="" name="id" value="<?php echo $candidature['id']; ?>" class="form-control" id="name">
                                            
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="" name="id_offre" value="<?php echo $candidature['id_offre']; ?>" class="form-control" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="" name="id_user" value="<?php echo $candidature['id_user']; ?>" class="form-control" >
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input readonly type="date" name="date" value="<?php echo $candidature['date']; ?>" class="form-control" id="subject">
                                            
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input  type="text" name="cv" value="<?php echo $candidature['cv']; ?>" readonly class="form-control" id="message" style="height: 150px"></input>
                                            <input type="file" name="new_cv">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input  type="text" name="lettre" value="<?php echo $candidature['lettre']; ?>" readonly class="form-control" id="subject">
                                            <input type="file" name="new_lettre">
                                        </div>
                                    </div>
                                    <div class="col-12">
