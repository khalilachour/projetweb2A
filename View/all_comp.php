...
// Supposons que vous ayez une méthode pour récupérer la liste des compétences par candidature
$competences = $CC->listCompetences(); // Récupération de la liste des compétences par candidature
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        ...
                        <h6 class="position-relative d-inline text-primary ps-4">Contact Us</h6>-->
                            <h2 class="mt-2"><a class="btn btn-link" href="afficher_cand2.php?offre_id=<?= $_GET['offre_id'] ?>">Voir Candidatures</a></h2>
                            <h2 class="mt-2"><a class="btn btn-link" href="afficher.php">Liste des offres</a></h2>

                        </div>
                        <form id="searchForm">
    <input id="mysearch" type="text" placeholder="rechercher par nom">
</form>
    ...
    <?php foreach ($competences as $competence) { ?>
        <tr>
            ...
            <td><?php echo $competence['id_cand'] ?></td>
            <td><?php echo $competence['nom'] ?></td>
            <td><?php echo $competence['niveau'] ?></td>
            <td><?php echo $competence['description'] ?></td>
            <!--<td><button><a href="modif_comp.php?id=<?php echo $competence['id'] ?>">Update</a></button></td>
            <td><button><a href="supp_comp.php?id=<?php echo $competence['id']; ?>&id_candidature=<?php echo $_GET['id_candidature']; ?>">Delete</a></button></td>
    -->
        </tr>
    <?php } ?>
    </tbody>                          
